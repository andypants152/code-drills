...
// Create a variable, ageAtPublish, and assign it a value of deathYear minus birthYear.

var ageAtPublish = yearOfPublish - birthYear;
...
var statementOne = "Programmers: " + fullName + " is a " + nationality + " " + profession + " born in " + birthYear + ".";
...
var statementThree = "In " + yearOfPublish + " she published the first Algorithm, " + firstAlgorithm + ", at the age of " + ageAtPublish + ".";
...
var statementFour = "She was a " + nationality + " Citizen who lived in " + cityLocation + ", " + countryLocation + " unitl her passing in " + deathYear + " at the age of " + ageAtPassing + ".";
